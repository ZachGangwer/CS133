...
window.onload=function(){document.getElementById("btn").onclick=function(){var a=document.getElementById("input").value,a=sanitize(a);countem(a)}};function sanitize(a){return isNaN(a)?(a=a.toString(),isNaN(a)?NaN:a):a}function countem(a){clearOutput();var b=["a","e","i","o","u"],c;a=$jscomp.makeIterator(a);for(var d=a.next();!d.done;d=a.next())for(var d=d.value,e=$jscomp.makeIterator(b),f=e.next();!f.done;f=e.next())d===f.value&&c++;write(c)}
function clearOutput(a){document.getElementById(a).innerHTML=""}function write(a){var b=document.createElement("li"),c=document.getElementById("output");b.appendChild(document.createTextNode(a));c.appendChild(b)};
